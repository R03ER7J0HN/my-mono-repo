...
mixin _$CategoryEntity {
 ...
 String get id;/// Category name (e.g., "Food", "Transportation")
 String get name;/// Flutter icon code point (e.g., Icons.restaurant.codePoint)
 int get iconCodePoint;/// Icon color as hex string (e.g., "#FF5733")
 String get colorHex;/// Whether this is a system/default category (cannot be deleted)
 bool get isSystem;/// Creation timestamp
...
@override
int get hashCode => Object.hash(runtimeType,id,name,iconCodePoint,colorHex,isSystem,createdAt);

@override
String toString() {
  return 'CategoryEntity(id: $id, name: $name, iconCodePoint: $iconCodePoint, colorHex: $colorHex, isSystem: $isSystem, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String name, int iconCodePoint, String colorHex, bool isSystem, DateTime? createdAt
});
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? iconCodePoint = null,Object? colorHex = null,Object? isSystem = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  int iconCodePoint,  String colorHex,  bool isSystem,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.iconCodePoint,_that.colorHex,_that.isSystem,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  int iconCodePoint,  String colorHex,  bool isSystem,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
return $default(_that.id,_that.name,_that.iconCodePoint,_that.colorHex,_that.isSystem,_that.createdAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  int iconCodePoint,  String colorHex,  bool isSystem,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.iconCodePoint,_that.colorHex,_that.isSystem,_that.createdAt);case _:
  return null;
...
class _CategoryEntity extends CategoryEntity {
  const _CategoryEntity({required this.id, required this.name, required this.iconCodePoint, required this.colorHex, this.isSystem = false, this.createdAt}): super._();
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? iconCodePoint = null,Object? colorHex = null,Object? isSystem = null,Object? createdAt = freezed,}) {
