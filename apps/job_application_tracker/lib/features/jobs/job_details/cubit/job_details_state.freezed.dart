...
@override
String toString() {
  return 'JobDetailsState.success()';
}
...
class _Failure implements JobDetailsState {
...
@override
String toString() {
  return 'JobDetailsState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $JobDetailsStateCopyWith<$Res> {
